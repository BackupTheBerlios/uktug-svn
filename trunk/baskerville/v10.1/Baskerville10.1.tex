...
% Version of UK-TUG without dropped U as preferred by the committee
\def \ukt {UK-TUG}
...
\fancyhead[LO]{}
\fancyhead[LE]{\BV}                          
\fancyhead[RO]{\textit{Volume 10, Number 1}}
\fancyhead[RE]{}
...
% ----------------------------------------------------------------------------------------
\section{Editorial}
Welcome to the revived \BV. \BV\ was for many years the journal of \ukt\ and archived copies are available through our website. The \ukt\ committee has decided to start anew publication of \BV\ and I have been co-opted onto the committee as editor. This is the first new issue. Since the purpose of \TeX\ is to produce ``marks on paper'' \BV\ has been printed and posted out; though the PDF version has been emailed out and is also available on the web. Contact me if you do not wish to receive paper copies of subsequent issues.

The journal is named after a serif typeface designed in 1757 by John Baskerville. Previous issues of \BV\ used the Baskerville font but this issue uses the default \textit{Computer Modern} font.

This particular issue is somewhat light in content. The quality of future issues will depend on \textit{you}, the membership of \ukt. I do not intend to create all the content myself, and welcome contributions on matters relevant to \TeX\ or \ukt.
...
% ----------------------------------------------------------------------------------------
\section{Baskerville Survey}
The committee of \ukt\ recently undertook a small online survey with regard to the preferred format for \BV. There were 34 responses and almost 90\% of respondents would prefer to see \BV\ in A4 format. Just over half want a printed copy.

There were several favourable comments regarding the return of \BV. Members of \ukt\ are looking for news about UK-TUG and TUG. They also want technical articles on various topics relating to \TeX\ and friends, such as on \LaTeX\ packages and ``how to'' articles.

These requests correspond with our vision for \BV\ and hopefully we can meet the high standards set by previous editors.
...
The Polish \TeX\ Users Group, GUST, have been holding an annual international \TeX\ conference since 1993. These conferences aim to popularize \TeX, \MF\ and other \TeX\ related software as well as typography in general.

The XVIIth Conference, Bacho\TeX\ 2009, was held at the traditional \TeX ies' and GUST meeting place, Bachotek near Brodnica, in the north-east of Poland, from 29 April until 3 May 2009 inclusive. The GUST AGM was held during the conference.

%Bacho\TeX\ 2009 is the XVIIth International Conference of the Polish \TeX\ Users Group (GUST) which took place at the traditional \TeX ies' and GUST meeting place, Bachotek near Brodnica, in the north-east of Poland, from 29 April until 3 May 2009 inclusive.
...
\begin{center}
\href{http://www.gust.org.pl/bachotex/2009/main-en.html?set_language=en}{www.gust.org.pl/BachoTeX/2009}
\end{center}

% ----------------------------------------------------------------------------------------
\subsection{Call for \TeX\ Pearls}
GUST, the organisers of Bacho\TeX, is seeking to continue the tradition of ``The Pearls of \TeX\ Programming''.
Briefly, Pearls are
\begin{itemize}
\item short and generic \TeX, \MF\ or \MP\ macros
\item code snippets that are easy to explain and preferably not obvious
\item sometimes obscure oddities, exhibiting weird \TeX\ behaviour -- dirty and risky tricks and traps are also welcome
...
Further details, and the collection of pearls, can be found at:
\begin{center}
...
The British Society for the History of Mathematics is hosting a workshop on the relationship between mathematics and fiction on 30 and 31 May 2009 at Rewley House, Oxford. The workshop will include readings and interviews with writers, talks about the uses of mathematics in fiction, and opportunities for discussion and debate.
...
\begin{center}
\href{http://www.bshm.org/meetings/Fiction.html}{www.bshm.org/meetings/Fiction.html}
\end{center}
...
TUG 2009 will take place in Notre Dame, Indiana, from 28 to 31 July.
This three-day conference focuses on practical techniques for document production using \LaTeX, \TeX, ConTeXt, \MP\ and friends.

For the registration form, maps, the proposals already accepted, and more see:
\begin{center}
\href{http://tug.org/tug2009}{tug.org/tug2009}
\end{center}

April had several deadlines related to the conference:

\begin{itemize}
	\item 13 April 2009: This is the deadline for abstract submissions; the call for papers is at: 
  \begin{center}
  \href{http://tug.org/tug2009/cfp.html}{tug.org/tug2009/cfp.html}
  \end{center}
  Although proposals may be accepted after the deadline, of course potential attendees would like to know what they'll be seeing. So if you'd like to give a talk, please try to submit an abstract by the 13th.
  
  \item 17 April 2009: This is the deadline for bursary applications; for information and the application form see:
  \begin{center}
  \href{http://tug.org/bursary}{tug.org/bursary} 
  \end{center}
...
\begin{center}
\href{http://tug.org/tug2009/register.html}{tug.org/tug2009/register.html}
\end{center}
\end{itemize}
...
\begin{wrapfigure}{R}{0.18\textwidth}
    \vspace{-10pt}
    \includegraphics[width=0.16\textwidth]{ukuug-2006.png}
    \vspace{-10pt}
\end{wrapfigure}
...
\begin{center}
\href{http://ukuug.org/events/summer2009/}{ukuug.org/events/summer2009}
\end{center}
One of the streams will be a half day training session on \textit{\TeX\ and typesetting}.
...
\noindent This is a somewhat easy, cryptic crossword and the solution can be found at the end of this issue.
...
Keyboards also have a pound sign (£), the use of which requires the package \texttt{inputenc}. Additionally, there is a standard command \textbackslash \texttt{pounds}, which renders as \pounds. This command works properly in both text mode and math mode.
...
\textcurrency & \textbackslash \texttt{textcurrency} \\
              & generic currency sign, it is a character used to denote a currency when the symbol for that currency is unavailable \\
\bottomrule
\end{tabular}
...
\begin{tabular}{p{2.2cm} p{4.3cm}}
\toprule\textbf{Symbol} & \textbf{\LaTeX}  \\
\textbf{Name}           & \textbf{Used in} \\
\midrule
...
\footnotetext[1]{This version of the dollar sign with two vertical lines is called the cifrão. Amounts are generally written so that it serves as the decimal separator, such as 20\textdollaroldstyle00 for 20 escudos.}
...
\footnotetext[2]{The denarius was a Roman coin. The dinar is a descendant of the denarius and is used, or was formerly used, by several countries. However, Serbia, for example, uses the Cyrillic De (\textcyrrm{D}) letter for the dinar.}
\footnotetext[3]{This symbol resembles a beta ($\beta$) but I believe it to be more akin to the German Eszett (\ss). It is possibly a symbol for the schilling, the pre-euro currency of Austria.}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{Wikipedia.png}
\end{center}

\medskip

In MediaWiki, \LaTeX\ commands are enclosed within the tags \texttt{<math>} and \texttt{</math>}; there is a button to insert these into the edit box. So a simple equation, such as Euler's formula, would be entered as
\begin{center}
...
\begin{center}
\includegraphics[width=0.35\textwidth]{Wikibooks-logo-en-bw.png}
\end{center}
...
Wikibooks, unlike most other wiki projects, has this year introduced reviewed pages. Reviewing assesses pages with regard to readability, accuracy and depth. A reviewed page is considered to be a stable version of that page. Reviewing can only be carried out by ``editors''. Editor status is automatically granted to contributors who have met various criteria such as having made sufficient edits and having a confirmed email address. All pages need to be reviewed, and re-reviewed if changed. In the \LaTeX\ Wikibook many pages still require to be reviewed.

\subsection{Conclusion}
All wiki content must be seen as a work-in-progress. If you don't like it -- you can fix it, improve it or start again from scratch. The \LaTeX\ Wikibook has several small chapters which need to be expanded; other chapters need to be enhanced, and more chapters could easily be added. There are also two very short and incomplete Wikibooks on \TeX.
...
\subsection{Links}
\begin{description}
  \item[\LaTeX\ Wikibook:]                       \hfill \\ \href{http://en.wikibooks.org/wiki/LaTeX}{en.wikibooks.org/wiki/LaTeX}
  \item[\TeX\ Wikibook:]                         \hfill \\ \href{http://en.wikibooks.org/wiki/TeX}{en.wikibooks.org/wiki/TeX}
  \item[\TeX\ for the Impatient Wikibook:]       \hfill \\ \href{http://en.wikibooks.org/wiki/TeX_for_the_Impatient}{en.wikibooks.org/wiki\slash TeX\_for\_the\_Impatient}
  \item[Wikibooks guide to reviewing pages:]     \hfill \\ \href{http://en.wikibooks.org/wiki/Using_Wikibooks/ Reviewing_Pages}{en.wikibooks.org/wiki/Using\_Wikibooks\slash Reviewing\_Pages}
  \item[Wikpedia article on \LaTeX:]             \hfill \\ \href{http://en.wikipedia.org/wiki/LaTeX}{en.wikipedia.org/wiki/LaTeX}
  \item[Wikipedia help on displaying formul\ae:] \hfill \\ \href{http://en.wikipedia.org/wiki/Help:Displaying_a_formula}{en.wikipedia.org/wiki\slash Help:Displaying\_a\_formula}
\end{description}
