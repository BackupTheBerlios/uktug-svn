...
\textbf{ISSN 1354-5930}                          & \textbf{Editor: Jonathan Webley} & \textbf{January 2009}
\end{tabular}}
\rule{15.5cm}{1pt}
\end{small}
}
...
\fancyhead[R]{\textbf{Vol. 10 No. 1} \\ \textbf{January 2009}}
...
\section{Membership List}  % use *-form to suppress numbering

\begin{tabular}{ l l l }
\textbf{Name} & \textbf{Email address} \\
\textbf{Town} &  \\
Flintstone, F. & \small fred.flintstone@hotmail.com \\
Bedrock & \\[2ex]
Mouse, M. & \small m.mouse@disney.com \\
Los Angeles & \\[2ex]
Oyl, O. & \small olive.oyl@aol.com \\
Cape Cod \\[2ex]
\end{tabular}
